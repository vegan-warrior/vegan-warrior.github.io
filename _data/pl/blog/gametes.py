...
Przy takiej asymetrii samiec może potencjalnie zapłodnić nieograniczoną liczbę partnerek, produkując plemniki w gigantycznych ilościach, a samica jest ograniczona zasobami niezbędnymi do ciąży i opieki nad potomstwem[^3]. **Stąd rodzi się nasza eksploatacja.**
...
„Uczciwa" strategia dużych gamet otworzyła drogę „egoistycznej" i „eksploatatorskiej" strategii małych[^4]. W wyniku nieustannej walki przetrwały i wykrystalizowały się zarówno ekstremalnie duże i uczciwe altruistki, jak i ekstremalnie małe i zwinne gamety. Jestem pewna, że domyślacie się, które z nich nazywamy dziś komórkami jajowymi, a które plemnikami.

Nie wdając się w dalsze perypetie poszukiwania ewolucyjnie stabilnej strategii (ESS), można z całą pewnością stwierdzić, że u większości gatunków praca związana z opieką nad potomstwem i zapewnieniem mu zasobów spada na samicę — szczególnie u ssaków i u nas, ludzi[^5]. Samica inwestuje własne zasoby organizmu w ciążę, przechodzi zmiany hormonalne, a po porodzie zapewnia opiekę i karmi mlekiem, którego wytworzenie również nie jest proste.
...
html_title = 'Do feminizmu przez biologię'
article = {
    'author_name': 'Lilith',
