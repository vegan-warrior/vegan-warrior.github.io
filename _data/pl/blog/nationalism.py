...
Po pierwsze, same zmiany klimatyczne - to efekt działalności człowieka. Jeśli się z tym nie zgadzasz, gratuluję, jesteś ciemniakiem[^3]. Wszak w środowisku naukowym panuje bezwzględny konsensus w tej sprawie.

Nasza cywilizacja zawdzięcza swoje istnienie łańcuchom logistycznym[^4], które umożliwiają transportowanie surowców energetycznych i towarów dosłownie na drugi koniec świata. To sprawia, że wszystkie kraje są wzajemnie od siebie zależne w każdym zakresie: gospodarczym, energetycznym i politycznym. A co najważniejsze - ekologicznym. Przecież awaria w jakiejkolwiek fabryce prowadzi do zanieczyszczenia setek i tysięcy kilometrów rzek i jezior. Plastikowa butelka, którą wyrzucisz do strumienia przy domu[^5], po kilku miesiącach lub roku łatwo może trafić do żołądka wieloryba w Oceanie Spokojnym. Awaria elektrowni jądrowej może uczynić cały kontynent niezdatnym do życia[^6]. I takich przykładów można podać nieskończoność.
...
Czy polityczny lider zaryzykuje stabilnością i rozwojem swojego kraju w imię populacji znikających tygrysów czy ryb?
...
Wyobraźcie sobie bawiuna, który widzi pośrodku sawanny palmę z bananami[^7].

Wszystko byłoby w porządku, gdyby nie to, że przy palmie krąży lew.

Teraz przed bawiunem pojawia się szereg bardzo ważnych pytań:
- jak bardzo jest głodny?
- ile bananów jest na palmie?
- jak daleko jest do niej?
- a jak daleko od palmie jest lew?
- czy bawiun może poczekać, aż lew odejdzie, czy osłabnie z głodu?
- czy lew wygląda na najedzonego, czy głodnego i agresywnego?
...
![Bawiun](../../_media/blog/nationalism_4.jpeg)
...
Tak, badania pokazują, że sędziowie (w krajach z bardziej lub mniej niezależnym systemem sądowniczym) mają tendencję do wydawania bardziej surowych wyroków związanych z pozbawieniem wolności, jeśli … są głodni[^8]… Jak to proste, prawda? To właśnie głód powoduje wzrost poziomu glikokortykoidów w organizmie, a w konsekwencji zwiększa stres i agresję, aktywując migdałek. Ale nie będziemy się teraz rozpraszać.
...
Koniec, algorytm biologiczny "człowiek" zhakowany[^9]!
...
A jeśli inne kraje użyją tego przeciwko nam?! Jak straszne! Musimy natychmiast skierować wszystkie środki na rozwój nowego oprogramowania i najbardziej rozwiniętej sztucznej inteligencji[^10]!
...
Od momentu, gdy ludzkość osiągnęła pewien poziom rozwoju technologicznego, w którym mała grupa ludzi ma możliwość zrównania z powierzchni ziemi całe miasta i państwa[^11], izolacjonizm poszczególnych krajów to w zasadzie obłęd.
...
[^1]: Yuval Noah Harari, "21 Lessons for the 21st Century". Sindbad, Moskwa, 2022.

[^2]: John Zerzan, "Future Primitive", zbiór artykułów i esejów.

[^3]: Metaanaliza 88 125 recenzowanych prac naukowych opublikowanych w latach 2012-2020, Uniwersytet Cornell.

[^4]: Derrick Jensen, "Endgame".

[^5]: Badania naukowe opublikowane w czasopiśmie PLOS One 2 grudnia 2020 r. GPS znacznik w butelce wyrzuconej do rzeki pokazał trasę 1767 mil (2844 km).

[^6]: Georgij Lepin i Iwan Smoljar "Energetyka jądrowa - „pokojowy” zabójca".

[^7]: Robert Sapolsky, "Biologia dobra i zła", Alpina Non-fiction, Moskwa, 2021.

[^8]: Robert Sapolsky, "Biologia dobra i zła", Alpina Non-fiction, Moskwa, 2021.

[^9]: Yuval Noah Harari, "21 Lessons for the 21st Century". Sindbad, Moskwa, 2022.

[^10]: "The Social Dilemma", dokument Netflix, 2020 r.
...
article = {
    ...
    'link': '/pl/blog/nationalism.html',
    'excerpt': "Dlaczego wiara w nacjonalistyczne, etniczne i inne formy szkodliwych mitologii nie jest tylko rekonstrukcją i historycznym atawizmem, ale przede wszystkim poważną przeszkodą na drodze do nie mniej, nie więcej ratowania Życia na planecie Ziemia.",
}
